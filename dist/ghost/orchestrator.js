...
import { spawnCommands, stopProject as pmStopProject, isProjectRunning, } from './process-manager.js';
...
export async function readGhostfile(projectPath) {
...
function assertGhostfile(value, filePath) {
...
async function parseEnvFile(projectPath, envFile) {
...
export async function openProject(name, options) {
...
export async function stopProject(name, options) {
