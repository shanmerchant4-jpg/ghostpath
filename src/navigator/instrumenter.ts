...
function hookFilePath(projectName: string): string {
...
function generateHookContent(projectName: string): string {
  return `'use strict';
...
export function createHook(projectName: string): string {
